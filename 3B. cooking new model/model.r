...
df_larvae_in_portions <- df_larvae_in_portions %>% 
  mutate( larvae_rare = round( inactivation( I0=larvae_per_portion,
                                             T0=rare.start.temp,
                                             T1=rare.end.temp, 
                                             t1=rare.end.time ) ),
          larvae_welldone = round( inactivation( I0=larvae_rare,
                                                 T0=welldone.start.temp,
                                                 T1=welldone.end.temp, 
                                                 t1=welldone.end.time ) ),
          larvae_medium   = round( inactivation( I0=larvae_rare, 
