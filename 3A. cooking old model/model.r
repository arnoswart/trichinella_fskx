...
df_larvae_in_portions <- df_larvae_in_portions %>% 
  mutate( larvae_rare = round(inactivation( k=inactivation_parameter, alpha.plus=alpha_plus, T.star=T_star, I0=larvae_per_portion,T0=rare_start_temp,T1=rare_end_temp, t1=rare_end_time ) ),
          larvae_welldone = round(inactivation( k=inactivation_parameter, alpha.plus=alpha_plus, T.star=T_star, I0=larvae_rare, T0=rare_end_temp,T1=welldone_end_temp, t1=welldone_end_time ) ),
          larvae_medium   = round(inactivation( k=inactivation_parameter, alpha.plus=alpha_plus, T.star=T_star, I0=larvae_rare, T0=rare_end_temp,T1=medium_end_temp, t1=medium_end_time ) ),
